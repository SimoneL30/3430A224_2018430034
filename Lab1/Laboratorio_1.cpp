...
//  Se agregan pacientes iniciales
    agregarPaciente(cabeza, "Charlotte", 1, 1.10, 11.200);
    agregarPaciente(cabeza, "Agatha", 8, 1.40, 40.500);
    agregarPaciente(cabeza, "Jessica", 50, 1.65, 90.400);

//  Se llama a la funcion menú para que se ejecute
    menu(cabeza);
